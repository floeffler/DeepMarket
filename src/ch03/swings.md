...
![Marktstruktur mit klar definierten HH/HL und LL/LH. Trendphasen sind gut erkennbar – Übergänge zwischen ihnen erfolgen oft über Seitwärtszonen.](../../assets/swings.png){#fig:swings}
...
![Der Versuch, das fallende Messer zu fangen. Jeder Dip sieht nach Boden aus – bis der Markt zeigt, dass er noch tiefer kann. Der heulende Ponke weiß: Reversals zu timen ist kein Plan, sondern Hopium.](../../assets/the_dip.png){#fig:the_dip}
...
![Elliott-Struktur mit vollständigem Impuls, ABC-Korrektur und erneutem Impuls mit Retest nach Channel Breakout](../../assets/impulse_correction.png){#fig:impulse_correction}
